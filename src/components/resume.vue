<template>
  <div>
    ...
    <!-- <el-dialog title="新建简历" :visible.sync="dialogFormVisible" :modal-append-to-body="false" class="myDialog">
      <el-form :model="resumeList" status-icon :rules="resumerules" ref="resumeInfo" label-width="120px"
        ...
        <el-form-item label="性别" prop="sex">
          <el-select class="fullRow" v-model="resumeList.sex" placeholder="请选择性别" >
            <el-option label="男" value="男"></el-option>
            <el-option label="女" value="女"></el-option>
          </el-select>
        </el-form-item>
        ...
        <el-form-item class="fullRow" label="毕业年份" prop="endTime">
 ...
 -->
  <!-- <NewResume :create="dialogFormVisible"></NewResume> -->
